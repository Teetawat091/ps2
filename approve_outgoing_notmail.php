...
$sql_query = "select * from `user_outgoing` "; //where user_id = $_SESSION[ss_user_id] 
    ...
    <td align='center'><table id='hor-minimalist-b' >
        <thead>
          <tr>
			...
			<th align="center">ค่าเดินทาง</th>
			<th align="center">ระยะทาง</th>
			<th align="center">ยานพาหนะ</th>
			<th align="center">อนุมัติ</th>
			<th align="center">ไม่อนุมัติ</th>
...
$sum_leave = 0;
		 ...
		 ?></td>
			...
			<td align="center"><?php echo $arr['cost'];?></td>
            <td align="center"><?php echo $arr['distance']; ?></td>
            <td align="center"><? echo $arr['vihecle_type']?></td>

            <td align="center"><a href="approve_outgoing.php?goingid=<?php echo $arr['user_outgoing_id'];?>"><img src="checked_checkbox.png" width="20" height="20"></a></td>
            <td align="center"><a href="non_approve_outgoing.php?goid=<?php echo $arr['user_outgoing_id'];?>"><img src="checked_checkbox.png" width="20" height="20"></a></td>
            <td align="center"><? echo $all_status[$arr['status']]; ?></td>
            </tr>
          <? 
