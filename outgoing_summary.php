...
$sum_leave = 0;
          ...
          <tr>
            ...
            $resultset = mysqli_query($_SESSION['connect'],$namesql);
            $num = mysqli_num_rows($result);
            $res = mysqli_fetch_assoc($resultset,MYSQLI_BOTH);
		 ...
		 ?></td>
			...
			?></td>
			<td align="center" ><?php echo $arr['description']."<br>"; ?></td>
			<td align="center" ><?php
				echo $all_status[$arr['status']];
			 ?></td>
            <td align="center"><?php echo $all_status[$arr['dayoff_change_status']]; ?></td>
            </tr>
          <?
