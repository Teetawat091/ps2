...
<script>
	function RelaodPage(){
		window.location.href = "report_leave_user.php?branch_id="+document.getElementById("branch_id").value+"&owner_user_id="+document.getElementById("owner_user_id").value+"&year="+document.getElementById("year").value;
	}
...
<table border='0' style='width:100%; margin-top:15px; font-size:40px;' cellspacing='0' cellpadding='0' align='center' class='bordered'>
  <tr>
	...
	<select  style="width:250px; font-size:30px;" name="owner_user_id" id="owner_user_id" onchange="RelaodPage()">
	  ...
	  ?>
	  </select> ประจำปี <select  style="width:90px; font-size:30px;" name="year" id="year" onchange="RelaodPage()">
  ...
  <?  
if($all_user_name[$_GET[owner_user_id]] != ""){
$all_apporve_name[0] = "-";
...
?>
		  ...
		  <tr><td colspan="10" style="border-bottom:none;">&nbsp;</td></tr>
<? 
$sum_leave = 0;
		 ...
		 ?></td>
            ...
            <td align="center"><div align=center><a onclick="show_detail(<? echo $arr[0] ?>);"><img src='page.png' width='20' height="20"   /></a></div></td>
			 <td align="center"><a href="dayleave_delete.php?dayleave_id=<? echo $arr[dayleave_id]; ?>&owner_user_id=<? echo $_REQUEST[owner_user_id]; ?>&year=<? echo $_REQUEST[year]; ?>&branch_id=<? echo $_REQUEST[branch_id]; ?>" onclick="return  confirm('ยืนยันการลบวันลา วันที่ <? echo $arr['date_request']; ?> ')" ><img src="Remove-icon.png" width="20" /></a></td>
		  </tr>
          <? 
		  $tmp = $arr['user_id'];
		  $i++; 
